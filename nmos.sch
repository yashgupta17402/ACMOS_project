...
"}
C {devices/code_shown.sym} -280 -1040 0 0 {name=NGSPICE_CTRL only_toplevel=true 
value="
.option sparse
.temp 27
.param wx=5u lx=0.13u vbx=0 vsd=0.1
...
C {devices/vsource.sym} 780 -240 0 0 {name=vd value=\{vsd\}}
