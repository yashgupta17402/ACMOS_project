...
descr="rg="}
C {devices/code_shown.sym} 540 -1040 0 0 {name=NGSPICE_SAVE only_toplevel=true 
value="
.save b d g n
...
C {devices/vsource.sym} 730 -170 0 0 {name=vd value=\{vds\}}
...
.option sparse
.temp 27
.param wx=5u lx=0.13u vbx=0 vds=0.1
...
compose l_vec  values 0.13u 0.26u 0.39u 0.52u 0.65u 0.78u 0.91u 1.04u 1.17u 1.30u
compose vg_vec start= 0 stop=1.5  step=25m
compose vd_vec values 0.1 0.2 0.4 0.6 1.5
